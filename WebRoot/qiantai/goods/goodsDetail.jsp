				...
				<div class="NewContainer771">
					...
					<div class="Slot">
						...
						<table width="680px" border="0">
						    ...
						    <tr>
						       <td align="center">商品名称：<s:property value="#request.goods.goodsName"/><hr/></td>
						    </tr>
						    <tr>
						       <td align="center">商品介绍:<s:property value="#request.goods.goodsMiaoshu" escape="false"/><hr/></td>
						    </tr>
						    <tr>
